...
Describe "$cmdlet_name PS$ps_version tests" {
    Context 'Strict mode' {
        ...
        It 'Should return success Win32 Error Message' {
            ...
            $actual = Get-Win32ErrorFromNtStatus -ErrorCode 0
        ...
        It 'Should convert NtStatus error to Win32' {
            ...
            $actual = Get-Win32ErrorFromNtStatus -ErrorCode ([System.UInt32]"0xC0000022")
        ...
        It 'Should handle large int values' {
            ...
            $actual = Get-Win32ErrorFromNtStatus -ErrorCode ([System.UInt32]"0xC03A0019")

            $actual | Should -Be $expected
        }

        It 'Should handle unmapped error codes' {
            $expected = 'Unknown NtStatus Error (ErrorCode 2290649224 - 0x88888888)'
            $actual = Get-Win32ErrorFromNtStatus -ErrorCode ([System.UInt32]"0x88888888")
