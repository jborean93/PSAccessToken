...
Describe "$cmdlet_name PS$ps_version tests" {
    Context 'Strict mode' {
        ...
        It 'Gets the token owner for current process' {
            $expected = [System.Security.Principal.WindowsIdentity]::GetCurrent().Owner
            ...
            $actual_owner.Translate([System.Security.Principal.SecurityIdentifier]) | Should -Be $actual
        }
