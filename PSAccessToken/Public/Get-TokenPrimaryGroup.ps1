...
Function Get-TokenPrimaryGroup {
    ...
    .OUTPUTS
    The SecurityIdentifier of the primary group of the access token.
    ...
    Get-TokenInformation @PSBoundParameters -TokenInfoClass ([PSAccessToken.TokenInformationClass]::PrimaryGroup) -Process {
        ...
        New-Object -TypeName System.Security.Principal.SecurityIdentifier -ArgumentList $token_group.PrimaryGroup
    }
}