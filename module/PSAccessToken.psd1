...
#
# Module manifest for module 'PSAccessToken'
#
...
GUID = '5a1d20a4-bd69-4842-a9a5-1d4222dbc573'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/jborean93/PSAccessToken/blob/main/LICENSE'
        ...
        ReleaseNotes = 'See https://github.com/jborean93/PSAccessToken/blob/main/CHANGELOG.md'
